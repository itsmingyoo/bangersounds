...
Revision ID: ba75a0d66bed
Revises: 
Create Date: 2023-09-17 12:47:52.793830
...
def upgrade():
    ...
    sa.Column('updatedAt', sa.DateTime(), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('song_ids', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['song_ids'], ['songs.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
