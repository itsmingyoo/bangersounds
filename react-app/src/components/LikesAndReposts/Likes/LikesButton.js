...
// function LikesButton({ productId, handleUnfavoriteClick, handleFavoriteClick, initialState }) {
//   const [solid, setSolid] = useState(initialState);
//   const dispatch = useDispatch;
//   const currentUser = useSelector((state) => state.session.user);
//   let userFavorites = useSelector((state) => Object.values(state.favorites.userFavorites));
...
//   return (
//     <div onClick={() => handleFavorite(productId)} id="favorite-icon__container">
//       <i
//         className={
//           solid || userFavorites.filter((favs) => favs.id === productId).length
//             ? `fa-solid fa-heart`
//             : `fa-regular fa-heart`
//         }
//       ></i>
