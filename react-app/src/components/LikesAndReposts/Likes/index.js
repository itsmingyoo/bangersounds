...
//         {userFavorites.length || (!userFavorites.length && searching) ? (
...
//                 <h3 onClick={(e) => history.push(`/products/${fav.id}`)} id="fav-item__name">
//                   {fav.item_name}
//                 </h3>
//                 <div onClick={(e) => history.push(`/products/${fav.id}`)} id="fav-item__username">
//                   {fav.Seller.first_name} {fav.Seller.last_name}
//                 </div>
